...
const Portfolio = ({setTabTitle, backToTop, applyHideClass, revealOnScroll, isMenuOpen, headerRef, toggleMenu, closeMenu}) => {
	const tabTitle = "Portfolio | Arnaud De Baerdemaeker";
	const projects = [
		{
			title: "Mon site",
			image: myWebsite,
